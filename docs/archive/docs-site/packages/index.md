...
| ------------------------------ | --------------------------------------------------------------------- | ----------------------------------------------------------------------------------------- | -------------------------------------------------- |
| `@sealant/workspaces`          | Workspace domain orchestration for build, publish, runtime, and queue | `@sealant/db`, `@sealant/rabbitmq`, `@sealant/source-integrations`, `@sealant/validators` | [workspaces.md](./workspaces.md)                   |
...
| `@sealant/db`                  | Shared PostgreSQL + Drizzle state for workspaces                      | None                                                                                      | [db.md](./db.md)                                   |
...
This order mirrors the workspace lifecycle path from contracts and transport through orchestration
and state.

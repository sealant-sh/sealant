...
| Object                     | Name                | Notes                                                                                                                                                                                                                                                                                                                                                                              |
| -------------------------- | ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Pod                        | `ws-<token>`        | `restartPolicy: Never`, `automountServiceAccountToken: false`, `/run/sealant` from `emptyDir`, store subPath mounts (a `capture` source instead gets its workspace root from an `emptyDir` and mounts no store claim), launch Secret projected at `/run/sealant/launch`, TLS Secret at `/run/sealant/tls`, resources, PriorityClass, topology spread, optional `runtimeClassName`. |

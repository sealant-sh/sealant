...
export const workerRuntimeEnvSchema = z.object({
  ...
  // with its exit code instead of staying `ready` until someone probes it. Docker also reports
  // exits as they happen (`docker events`); this poll is the convergence net behind that stream
  // and the only mechanism on Kubernetes.

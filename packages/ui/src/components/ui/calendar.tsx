import { Button, buttonVariants } from "@sealant/ui/components/ui/button";
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn(
          "rounded-(--cell-radius) font-medium text-primary data-[selected=true]:text-primary-foreground",
      ...
      components={{
        ...
        DayButton: ({ ...dayButtonProps }) => (
          <CalendarDayButton {...(locale !== undefined ? { locale } : {})} {...dayButtonProps} />
        ),

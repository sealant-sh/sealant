...
const TIMELINE: readonly WireTimelineEntry[] = [
  entry("processStarted", { executable: "opencode", args: ["run", "Append a line."], cwd: "/sandbox/repo" }),
  ...
  entry("processStarted", { executable: "sh", args: ["-lc", "git diff --cached"], cwd: "/sandbox/repo" }),

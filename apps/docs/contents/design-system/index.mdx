---
title: Design system
description: The Evidence Review design language for Sealant — tokens, type split, four-color discipline, components, and the things the surface refuses to render.
---
...
<Accordions>
  <Accordion title="No panel tinted green, amber, or red">
    Color marks a value or a word — it never floods a region, because a tinted panel renders a verdict.
  </Accordion>
  ...
  <Accordion title="No banned register">
    Phrases like "strong proof," "high confidence," "all checks passed," and "safe to merge" each substitute the tool's verdict for the reviewer's.
  </Accordion>
</Accordions>

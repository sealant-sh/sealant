...
function AboutPage() {
  return (
    <section className="border border-border bg-card px-6 py-8 sm:px-8 sm:py-10 lg:px-10">
      <p className="font-mono text-[0.68rem] uppercase tracking-[0.16em] text-muted-foreground">Platform Brief</p>
      <h1 className="mt-5 font-display text-6xl uppercase tracking-[0.02em] leading-[0.86] text-foreground sm:text-7xl">Sealant</h1>

...
import { RUNS, getRepositoryById } from "@/lib/navigation/sandbox-data";

export const Route = createFileRoute("/_authenticated/repositories/$repoId/sandboxes")({
...
function RepositoryRunsPage() {
  ...
  return (
    <RepositoryDetailSection
      ...
      section="Sandboxes"
      description="Inspect execution history for this repository and open failed sandboxes directly into their detailed sandbox navigation."
    >
      <RunRows runs={runs} />
    </RepositoryDetailSection>
  );

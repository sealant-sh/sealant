...
export const Route = createFileRoute("/_authenticated/workspaces/$workspaceId/runs/$runId")({
    ...
    <section className="space-y-6">
      <header>
        <p className="ev-eyebrow">
          <Link to="/workspaces/$workspaceId" params={{ workspaceId }} className="hover:text-ink-2">
            {workspaceId}
          </Link>
          {" / runs"}
        </p>

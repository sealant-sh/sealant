...
// Reserved URL — a workspace's trace is its latest run record; without runs, fall back to the spec.
export const Route = createFileRoute("/_authenticated/workspaces/$workspaceId/trace")({
  loader: async ({
    context,
    params,
  }: {

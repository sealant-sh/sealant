            ...
            >
              {GLOBAL_NAV_ITEMS.map((item) => (
                <Link
                  ...
                  className="border-b-2 border-transparent text-[1rem] font-semibold tracking-[0.14em] text-muted-foreground no-underline transition duration-200 hover:text-foreground"
                  activeProps={{
                    className:
                      "border-primary text-[1rem] font-semibold tracking-[0.14em] text-primary no-underline",
                  }}
                >
                  {item.label}
                </Link>

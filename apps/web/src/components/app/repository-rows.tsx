  ...
  return (
    <div className="border border-border">
      {repositories.map((repository) => (
        ...
        >
          <div>
            <p className="font-mono text-[0.62rem] uppercase tracking-[0.13em] text-muted-foreground">Repository</p>
            <p className="mt-1 text-sm font-semibold text-foreground">{repository.name}</p>
          </div>
          <p className="font-mono text-[0.62rem] uppercase tracking-[0.13em] text-muted-foreground">{repository.owner}</p>
          <p className="font-mono text-[0.62rem] uppercase tracking-[0.13em] text-muted-foreground">{repository.branch}</p>
          <p className="font-mono text-[0.62rem] uppercase tracking-[0.13em] text-muted-foreground">{repository.health}</p>
        </Link>
      ))}
    </div>
  );

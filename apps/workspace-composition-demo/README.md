...
This app is the thin runnable layer on top of `packages/workspace-composition`.

It keeps the demo spec close to the commands you use locally, while all reusable builder logic stays in the shared package.
...
- `package.json`: small convenience scripts for building the reusable package examples

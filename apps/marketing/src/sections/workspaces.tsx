// §7 — REAL WORKSPACES & CONSOLE. The workspace is the platform object: a live,
...
// path *into* the workspace, never "dev containers." Create from the SDK or the console.
      ...
      <div className="flex items-center justify-between gap-3 border-b border-rule px-4 py-3">
        <span className="flex min-w-0 items-center gap-2">
          <span
            ...
            aria-hidden="true"
          />
          <span className="font-mono text-xs text-ink-2">ws_8m2k</span>
        </span>
...
export function Workspaces() {
  return (
    <section id="workspaces" className="bg-[var(--sw-canvas)] py-24 lg:py-32">
      <Container>
        <div className="grid items-start gap-12 lg:grid-cols-2 lg:gap-16">
          <Reveal className="order-2 min-w-0 space-y-4 lg:order-1">
            <WorkspaceConsole />
            <CodePanel title="workspace.ws_8m2k — ssh">
              <span className="block">
                <span className="text-[#9db4f0]">$ </span>
                <span className="text-[#e6e6ea]">ssh workspace.ws_8m2k</span>
              </span>
          ...
          <Reveal className="order-1 min-w-0 lg:order-2">
            <Eyebrow>Real workspaces, under your control</Eyebrow>
            ...
            <p className="mt-5 text-lg leading-relaxed text-muted-foreground">
              Sealant builds a container around a repository — code, dependencies, harness,
              processes, runtime commands, and services — and keeps it live and disposable. Use the
              SDK for automation or the console to create, inspect, restart, and enter workspaces.
            </p>
